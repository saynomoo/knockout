describe('Transclusion', function() {
    ...
    it('Transcludes contents', function() {
        ...
        var initialMarkup = '<div>hello <test-component>injectme</test-component></div>';
        testNode.innerHTML = initialMarkup;

        ko.applyBindings(null, testNode);
        jasmine.Clock.tick(1);
        expect(testNode).toContainHtml('<div>hello <test-component>custom element <span>content: "injectme"</span></test-component></div>');
    });
